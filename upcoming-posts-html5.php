...
if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
  ...
  $config = array(
        ...
        'raw_url' => 'https://raw.github.com/amberkayle/Upcoming-Posts-HTML5/master', // the github raw url of your github repo
        'github_url' => 'https://github.com/amberkayle/Upcoming-Posts-HTML5', // the github url of your github repo
        'zip_url' => 'https://api.github.com/repos/amberkayle/Upcoming-Posts-HTML5/zipball/master', // the zip url of the github repo
        'sslverify' => false, // wether WP should check the validity of the SSL cert when getting an update
